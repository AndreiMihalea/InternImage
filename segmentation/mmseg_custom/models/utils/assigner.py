...
class MaskHungarianAssigner(BaseAssigner):
    ...
    def __init__(self,
                 ...
                 jaccard_cost=dict(type='JaccardCost', weight=0.0)):
        self.cls_cost = build_match_cost(cls_cost)
        self.dice_cost = build_match_cost(dice_cost)
        self.mask_cost = build_match_cost(mask_cost)
        self.jaccard_cost = build_match_cost(jaccard_cost)
    ...
    def assign(self,
        ...
        if self.jaccard_cost.weight != 0:
            jaccard_cost = self.jaccard_cost(mask_pred, gt_masks)
        else:
            jaccard_cost = 0

        cost = cls_cost + mask_cost + dice_cost + jaccard_cost
